...
const styles = {
  page: {
    ...
    color: "#14213d",
    background:
      "radial-gradient(circle at 4% 8%, rgba(255,255,255,0.95) 0 1.5px, transparent 2px), radial-gradient(circle at 12% 54%, rgba(255,255,255,0.76) 0 10px, transparent 13px), radial-gradient(circle at 34% 18%, rgba(255,255,255,0.82) 0 9px, transparent 13px), radial-gradient(circle at 48% 48%, rgba(255,255,255,0.72) 0 18px, transparent 24px), radial-gradient(circle at 70% 18%, rgba(255,255,255,0.70) 0 12px, transparent 17px), radial-gradient(circle at 7% 18%, rgba(236,72,153,0.55), transparent 34%), radial-gradient(circle at 30% 14%, rgba(14,165,233,0.55), transparent 36%), radial-gradient(circle at 52% 30%, rgba(20,184,166,0.56), transparent 34%), radial-gradient(circle at 76% 22%, rgba(163,230,53,0.50), transparent 36%), radial-gradient(circle at 93% 15%, rgba(244,114,182,0.52), transparent 32%), radial-gradient(circle at 18% 82%, rgba(192,132,252,0.55), transparent 38%), radial-gradient(circle at 58% 82%, rgba(56,189,248,0.48), transparent 40%), linear-gradient(135deg, #ffffff 0%, #f8fdff 34%, #fffef3 72%, #ffffff 100%)",
