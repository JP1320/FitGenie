...
const styles = {
  page: {
    ...
    color: "#14213d",
    background:
      "radial-gradient(circle at 4% 8%, rgba(255,255,255,0.95) 0 1.5px, transparent 2px), radial-gradient(circle at 12% 54%, rgba(255,255,255,0.72) 0 10px, transparent 13px), radial-gradient(circle at 34% 18%, rgba(255,255,255,0.78) 0 9px, transparent 13px), radial-gradient(circle at 48% 48%, rgba(255,255,255,0.68) 0 18px, transparent 24px), radial-gradient(circle at 70% 18%, rgba(255,255,255,0.65) 0 12px, transparent 17px), radial-gradient(circle at 7% 18%, rgba(236,72,153,0.42), transparent 34%), radial-gradient(circle at 30% 14%, rgba(56,189,248,0.42), transparent 36%), radial-gradient(circle at 52% 30%, rgba(45,212,191,0.44), transparent 34%), radial-gradient(circle at 76% 22%, rgba(190,242,100,0.38), transparent 36%), radial-gradient(circle at 93% 15%, rgba(244,114,182,0.38), transparent 32%), radial-gradient(circle at 18% 82%, rgba(216,180,254,0.42), transparent 38%), radial-gradient(circle at 58% 82%, rgba(125,211,252,0.35), transparent 40%), linear-gradient(135deg, #ffffff 0%, #f8fdff 34%, #fffef3 72%, #ffffff 100%)",
